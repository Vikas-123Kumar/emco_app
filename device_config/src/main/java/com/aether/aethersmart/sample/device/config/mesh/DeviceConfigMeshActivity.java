package com.aether.aethersmart.sample.device.config.mesh;
...
import com.aether.aethersmart.sample.device.config.mesh.configByApp.SubConfigAppActivity;
import com.aether.aethersmart.sample.device.config.mesh.configByGateway.SubConfigGatewayActivity;
